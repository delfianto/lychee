...
DEMO: list[DemoSpec] = [
    DemoSpec("Dungeon Meshi", "manga", "jp", "completed", "seinen", 9.2, "safe",
             ("fantasy", "comedy", "adventure", "cooking"), 2014, ("Ryoko Kui",),
             ("Ryoko Kui",), favorite=True, unread=12, lib_status="reading", chapters=102,
             description="Adventurers cook and eat the monsters of a deadly labyrinth."),
    DemoSpec("Frieren: Beyond Journey's End", "manga", "jp", "ongoing", "shonen", 9.6, "safe",
             ("fantasy", "adventure", "drama"), 2020, ("Kanehito Yamada",), ("Tsukasa Abe",),
             favorite=True, unread=3, lib_status="reading", chapters=127,
             description="An elf mage journeys to understand the humans she outlived."),
    DemoSpec("Berserk", "manga", "jp", "hiatus", "seinen", 9.8, "mature",
             ("action", "fantasy", "horror"), 1989, ("Kentaro Miura",), ("Kentaro Miura",),
             favorite=True, lib_status="on_hold", chapters=375,
             description="A branded swordsman wages war against demonic fate."),
    DemoSpec("Vinland Saga", "manga", "jp", "ongoing", "seinen", 9.1, "mature",
             ("action", "adventure", "historical"), 2005, ("Makoto Yukimura",),
             ("Makoto Yukimura",), unread=7, lib_status="reading", chapters=210,
             description="A young Viking's revenge gives way to a search for peace."),
    DemoSpec("One Piece", "manga", "jp", "ongoing", "shonen", 9.3, "safe",
             ("action", "adventure", "fantasy"), 1997, ("Eiichiro Oda",), ("Eiichiro Oda",),
             lib_status="plan_to_read", chapters=1102,
             description="Luffy and his crew sail for the King of the Pirates' treasure."),
    DemoSpec("Chainsaw Man", "manga", "jp", "ongoing", "shonen", 8.7, "mature",
             ("action", "horror", "comedy"), 2018, ("Tatsuki Fujimoto",), ("Tatsuki Fujimoto",),
             favorite=True, unread=5, lib_status="reading", chapters=150,
             description="A devil-hunter fused with his chainsaw dog chases a normal life."),
    DemoSpec("Solo Leveling", "manga", "kr", "completed", "none", 8.5, "suggestive",
             ("action", "fantasy"), 2018, ("Chugong",), ("Dubu",), favorite=True,
             lib_status="completed", chapters=179,
             description="The weakest hunter gains the power to level up without limit."),
    DemoSpec("Saga", "comic", "us", "ongoing", "none", 9.0, "mature",
             ("sci-fi", "fantasy", "romance"), 2012, ("Brian K. Vaughan",), ("Fiona Staples",),
             favorite=True, unread=2, lib_status="reading", chapters=66,
             description="Star-crossed soldiers flee a galactic war with their newborn."),
    DemoSpec("Watchmen", "comic", "us", "completed", "none", 9.2, "mature",
             ("superhero", "mystery", "drama"), 1986, ("Alan Moore",), ("Dave Gibbons",),
             favorite=True, lib_status="completed", chapters=12,
             description="A murder pulls retired heroes into a world-ending conspiracy."),
    DemoSpec("The Sandman", "comic", "us", "completed", "none", 9.1, "mature",
             ("fantasy", "horror", "drama"), 1989, ("Neil Gaiman",), ("Sam Kieth",),
             favorite=True, chapters=75,
             description="Freed from captivity, Dream rebuilds his fractured realm."),
    DemoSpec("Frieren — Official Illustrations", "gallery", "jp", "completed", "none", 9.4, "safe",
             ("fantasy", "illustration", "official"), 2023, ("Tsukasa Abe",), ("Tsukasa Abe",),
             favorite=True, images=36, source="Frieren: Beyond Journey's End",
             characters=("Frieren", "Fern", "Stark"),
             description="Official character art and promotional illustrations."),
    DemoSpec("Chainsaw Man — Fan Art", "gallery", "jp", "completed", "none", 8.9, "suggestive",
             ("action", "fan-art"), 2022, ("Various Artists",), ("Various Artists",), images=52,
             source="Chainsaw Man", characters=("Denji", "Power", "Makima"),
             description="A community collection of Chainsaw Man fan illustrations."),
    DemoSpec("Marin Kitagawa — Cosplay", "gallery", "jp", "completed", "none", 8.6, "suggestive",
             ("cosplay",), 2023, ("Enako",), ("Enako",), images=28, source="My Dress-Up Darling",
             characters=("Marin Kitagawa",),
             description="Cosplay photosets of My Dress-Up Darling's Marin."),
    DemoSpec("Genshin Impact — Splash Art", "gallery", "cn", "completed", "none", 9.0, "safe",
             ("illustration", "official"), 2020, ("HoYoverse",), ("HoYoverse",), favorite=True,
             images=44, source="Genshin Impact",
